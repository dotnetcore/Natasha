...
public static class SyntaxNodeExtension
{
    ...
    public static string GetDataStructString<T>(SyntaxNode namespaceNode, int index = 0) where T : BaseTypeDeclarationSyntax
    {
    ...
    public static string GetFirstOopName(this SyntaxTree syntaxTree)
    {
