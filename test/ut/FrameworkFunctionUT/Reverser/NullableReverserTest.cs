...
namespace FrameworkFunctionUT.Reverser
{
    ...
    public class NullableReverserTest
    {
        ...
        public void ParameterInfoNullableTest()
        {
            foreach (var item in typeof(NullabelTestModel).GetMethods())
            {
                if (item.Name=="Show1")
                {
                    ...
                    Assert.Equal("FrameworkFunctionUT.Reverser.NullableReverserTest.NullabelTestModel?", parameters[0].GetMemberNullableDevelopName());
        ...
        public void SystemParameterInfoNullableTest2()
        {
            ...
            Assert.Equal("FrameworkFunctionUT.Reverser.NullableReverserTest.NullabelTestModel", parameters[0].GetMemberNullableDevelopName());
            Assert.Equal("FrameworkFunctionUT.Reverser.NullableReverserTest.NullabelTestModel?", parameters[1].GetMemberNullableDevelopName());
