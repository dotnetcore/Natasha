...
namespace FrameworkFunctionUT.Reverser
{
    ...
    public class GenericConstraintReverserTest
    {
        ...
        public void Test8()
        {
            ...
            Assert.Equal("where T : FrameworkFunctionUT.Reverser.G2, FrameworkFunctionUT.Reverser.G3, FrameworkFunctionUT.Reverser.G4, new() where S : FrameworkFunctionUT.Reverser.G2, FrameworkFunctionUT.Reverser.G3, FrameworkFunctionUT.Reverser.G4, new() ", result1);
        }
