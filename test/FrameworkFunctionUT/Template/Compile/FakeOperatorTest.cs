...
namespace FrameworkFunctionUT.Template.Compile
{
    ...
    public class FakeOperatorTest : DomainPrepare
    {
        ...
        public void MakerCode1()
        {
            ...
            var builder = FakeMethodOperator.DefaultDomain();
            builder
        ...
        public void MakerCode2()
        {
            ...
            OSStringCompare.Equal($@"public async System.Threading.Tasks.Task<FrameworkFunctionUT.Template.Compile.OopTestModel> ReWrite2(){{Console.WriteLine(""hello world"");return this;}}", builder.ScriptCache);
        ...
        public void MakerStaticCode2()
        {
            ...
            Assert.NotNull(builder.Compile());
            OSStringCompare.Equal($@"public static async System.Threading.Tasks.Task<FrameworkFunctionUT.Template.Compile.OopTestModel> ReWrite2(){{Console.WriteLine(""hello world"");return default;}}", builder.ScriptCache);
