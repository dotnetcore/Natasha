...
namespace Natasha
{
    public class NDomain
    {
        ...
        {
            return content == default ? null : DelegateOperator<Func<T>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Func<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>.Delegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>.AsyncDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>.UnsafeDelegate(content, _domain, usings);
        }
        ...
        {
            return content == default ? null : DelegateOperator<Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>.UnsafeAsyncDelegate(content, _domain, usings);
        }
    }
}
