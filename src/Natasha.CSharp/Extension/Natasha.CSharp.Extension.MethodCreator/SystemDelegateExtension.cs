...
namespace System
{
    public static class SystemDelegateExtension
    {
        ...
        public static Action<T1> ToAction<T1>(in this (string script, string[] usings, AssemblyCSharpBuilder builder) buildInfo)
        {
            return buildInfo.ToDelegate<Action<T1>>();
        }
        public static Action<T1, T2> ToAction<T1, T2>(in this (string script, string[] usings, AssemblyCSharpBuilder builder) buildInfo)
        {
            return buildInfo.ToDelegate<Action<T1, T2>>();
        }
        public static Action<T1, T2, T3> ToAction<T1, T2, T3>(in this (string script, string[] usings, AssemblyCSharpBuilder builder) buildInfo)
        {
            return buildInfo.ToDelegate<Action<T1, T2, T3>>();
        }
        public static Action<T1, T2, T3, T4> ToAction<T1, T2, T3, T4>(in this (string script, string[] usings, AssemblyCSharpBuilder builder) buildInfo)
        {
